...
# -*- mode:R -*-
#PBS
#PBS -j oe -o promoter-group-count-1kb.log
...
## Get 1000bp flanking regions around TSS
...
saveRDS(sexp, "promoter-group-counts-1kb.RDS")
write.table(assays(sexp)$counts, file="promoter-group-counts-1kb.txt")
